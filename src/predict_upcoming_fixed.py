...
def predict_upcoming_games():
    ...
    try:
        ...
        # Double-check that all dates are datetime objects
        logging.info("Ensuring all dates are datetime objects for consistency...")
        ...
        predictions_file = f'data/predictions/upcoming_games_fixed_{datetime.now().strftime("%Y%m%d")}.csv'
